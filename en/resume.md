...
Previous courses:
- Translation Management and Localization Engineering [(Chinese MOOC)](http://www.chinesemooc.org/mooc/4848)
...
Double Bachelor's Degree in English and Computer Science
 -->
...
**[IEEE Transactions on Professional Communication](https://procomm.ieee.org/transactions-editorial-staff-and-editorial-board/)**, Editorial Board Member

`2022 - Present`

**[The Journal of Medicine, Humanity and Media](http://mhmjournal.net/index.php/mhm/about/editorialTeam)**, Associate Editor
...
- Xiaomi — Neural-Network-Based Terminology Extraction
- CCTV.com — Writing Training for Engineers
- MCC Group — Application of AIGC in Translation, [News coverage](http://jiangsu.china.com.cn/html/2024/qy_0325/11203385.html)

### 2022
- BAIC Group — In-Vehicle Owner's Manuals for Various Car Models
- [Renogy](https://www.renogy.cn) — Solar Power Documentation Development
- Xiaomi — Manual Style Sheet Development

### 2021
- Ant Group — Developer Documentation UX Design
- Tmxmall — Application of Language Intelligence in Technical Writing

### 2020
- Xiaomi — Translation Order Management System
- Xiaomi — Terminology Portal
- Xiaomi — Tag-Assisted Generation System
- Shenzhen Technology University — Technical Writing Course Design

### 2019
- China Association for Standardization — Technical Writing Competency Certification Program
- Peking University — Professional Master's Case Library Development

### 2018
- Baidu — Computer-Aided Translation Tool Design Consulting
- Beijing Foreign Studies University — Translation Process Research
- Siemens — Minimalist Documentation Design Consulting
- MadCap Flare — Technical Writing Tool Localization

### 2016
- A Defense Contractor — Simplified Technical English Rule Checker for Aerospace and Defense

### 2014
- Liaoning Normal University — Computer-Aided Translation Teaching Platform (CATTP)

### 2013
- MCC Group — Remote Multi-User Collaborative Translation Environment
- Alchemy Catalyst 8.0 Software Localization
...
- **Gao, Z.**, Ji, C., & Liu, K. (2025). Enterprise terminology extraction practice based on large language models. *China Terminology*, 27(4), 136–141. DOI: [10.12339/j.issn.1673-8578.2025.04.031](https://doi.org/10.12339/j.issn.1673-8578.2025.04.031)
...
`2021`
*English Technical Writing*, Nanjing University Press, Contributing author

`2016`
*Translation Technology in Practice*, Foreign Languages Press, Contributing author

### Standards

`2024`

- *User Experience Assessment Specification for Technical Documentation*, April 11, 2024, Standard No.: T/CAS 852-2024, First author, China Association for Standardization

`2023`

- *User Experience — Service Capability Assessment Specification*, 2023, Standard No.: T/CQAE 15006–2023, China Electronic Quality Management Association. [Full text](https://uip.cqae.org.cn/api/fileManage/notice/down?fidOrFilename=892)

`2019`

- *General Technical Specification for Corpora*, released by the Translators Association of China, Standard No.: ZYF 001-2018. [Full text](http://www.tac-online.org.cn/uploadfile/2018/1013/20181013110348586.pdf)

`2016`

- *Glossary of Technical Communication Terms*, released by China Association for Standardization, Standard No.: T/CAS 245-2016. [[<u>Download</u>](https://www.gaozhijun.me/assets/download/t.cas.245.2016.pdf)]

### Patents

- Method, System, Device and Storage Medium for Outputting Document Content. Inventors: Yu Jingsong, **Gao Zhijun**, Dong Yongjia. Publication No.: CN115809638A, Publication Date: 2023-03-17

### Software Copyrights

- LECAT Intelligent Corpus Analysis Tool 1.0, Registration No. 16535734, Copyright holder: Gao Zhijun
- PKUCAT Large-Model-Assisted Translation Platform 1.0, Registration No. 16681619, Copyright holder: Gao Zhijun
...
- User Experience Assessment of Developer Documentation, Huawei Cloud User Experience Conference, Shenzhen, October 31, 2024
- The Development of a UX Scale for Technical Documentation, IEEE ProComm 2024, Carnegie Mellon University, Pittsburgh, July 15, 2024
- Enhancing Corpus Analysis with Large Language Models: A Novel Tool for Efficient and Intelligent Processing, International Symposium on Language Sciences, Hong Kong Polytechnic University, May 10–11, 2024
- [Large Language Models Drive Transformation in Translation Technology](https://www5.zzu.edu.cn/fld/info/1030/4328.htm), School of Foreign Languages, Zhengzhou University, Zhengzhou, April 26, 2024

`2023`

- UX Testing of Developer Documentation — A Case Study of OceanBase, IEEE ProComm 2023, Cornell University, Ithaca, July 18, 2023
- User-Centered: From Technical Writing to Information Experience Design, University of Macau, February 8, 2023

`2020`

- Designing the China Technical Writing Competency Exam, TCWorld China 2020, Shanghai, September 11, 2020

`2019`

- Quality Metrics for Help Centers, ACM SIGDOC 2019, Portland State University, October 5, 2019. <a href="https://sigdoc.acm.org/conference/2019/program/schedule/">[Conference schedule]</a>
- Line Length Design for Technical Documentation, IEEE ProComm 2019, RWTH Aachen University, Germany, July 24, 2019

`2017`

- User Assistance Design Based on Information Behavior, TC World 2017, Shanghai, August 21, 2017
- Technical Communication Education in China, TCWorld 2018, ICS Stuttgart, Germany, October 26, 2017

`2016`

- Standards in the Field of Technical Documentation in China, JTCA, Kogakuin University, Shinjuku, Tokyo, August 24, 2016
- Technical Communication Education in China, University of Westminster, London, October 9, 2016
...
- [2024 Peking University 7th Innovative Teaching Paper Competition](http://cetl.pku.edu.cn/peking/jsp/jspeditor9/to/facade.jsp?dispatch=viewObject&id=1183&af=/cetl/view1/viewObjectOk.jsp&editor_banner_longb=null&editor_longb=905&longa=9&FATHER_LONGB=999), First Prize — Gao Zhijun, Ji Chen, Xu Jing\*
- [Frank R. Smith Outstanding Article Award](https://www.stc.org/honors-awards-and-recognition/frank-r-smith-award/), Society for Technical Communication. [Announcement](https://www.stc.org/notebook/2024/04/24/2024-frank-r-smith-award-recipients-names/), [[<u>Certificate</u>](https://www.gaozhijun.me/assets/download/STC-Award.pdf)]

`2023`

- Outstanding Class Advisor of the Year, Peking University

`2021`

- 10th PKU Innovative Teaching Application Competition, Third Prize — Yu Jingsong, **Gao Zhijun**

`2020`

- Contribution Award for Technical Communication Education in China, China Association for Standardization

## Professional Service

`2022.08.10 - Present`
Secretary-General, [Subcommittee on Computer-Aided Terminology Work, National Technical Committee on Language and Terminology Standardization](https://std.samr.gov.cn/search/orgDetailView?tcCode=TC62/SC3)

`2019.01.01 - Present`
Secretary-General, __Technical Communication Service Committee, China Association for Standardization__

`2019.01.01 - Present`
Member, __Localization Services Committee, Translators Association of China__

`2022 - 2024`
Board Member, __[IEEE Professional Communication Society](https://procomm.ieee.org/leadership/)__
